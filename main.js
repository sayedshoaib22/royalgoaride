...
// ══════════════════════
const routes = [
  { title: 'North Goa Beach Blitz', dur: '1 Day', img: 'https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&fit=crop&q=80&w=800', route: 'Margao → Calangute → Baga → Anjuna → Vagator', desc: 'Hit the legendary north coast beaches in one epic day. From bustling Baga to chilled Vagator, this covers all the famous spots.', tags: ['Beaches', 'Nightlife', 'Shacks'], car: 'Best in: Swift / Ignis' },
  { title: 'Old Goa Heritage Loop', dur: '1 Day', img: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&q=80&w=800', route: 'Margao → Panaji → Old Goa → Dona Paula', desc: "Explore Goa's Portuguese soul — majestic basilicas, colonial mansions, the Latin Quarter, and sea-facing viewpoints.", tags: ['Heritage', 'Culture', 'Architecture'], car: 'Best in: Baleno / i20' },
  { title: 'South Goa Serenity Drive', dur: '1 Day', img: 'https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&fit=crop&q=80&w=800', route: 'Margao → Colva → Benaulim → Palolem → Agonda', desc: "Quieter, more serene south beaches with pristine sands. Palolem is one of India's most beautiful crescent bays.", tags: ['Serene', 'Nature', 'Relaxation'], car: 'Best in: Brezza / Creta' },
  { title: 'Dudhsagar Adventure', dur: 'Full Day', img: 'https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&q=80&w=800', route: 'Margao → Dudhsagar → Wildlife Sanctuary', desc: "Chase Goa's spectacular Dudhsagar waterfall through wildlife reserve roads. Rugged terrain, incredible views, unforgettable.", tags: ['Adventure', 'Wildlife', 'Waterfall'], car: 'Best in: Thar Hardtop / Fortuner' },
  { title: 'Goa Coastal Sunset Tour', dur: '4 Hours', img: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80&w=800', route: 'Margao → Fort Aguada → Sinquerim → Candolim', desc: "The golden hour drive along Goa's coast, ending at the iconic Fort Aguada for a breathtaking sunset over the Arabian Sea.", tags: ['Sunset', 'Fort', 'Photography'], car: 'Best in: Mini Cooper / Audi' },
  { title: 'Spice Farm &amp; Temples', dur: '1 Day', img: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&q=80&w=800', route: 'Margao → Ponda Spice Farms → Shri Mangeshi Temple', desc: 'Authentic Goa — fragrant spice plantations, traditional cooking, and ancient temples away from the tourist rush.', tags: ['Culture', 'Food', 'Temples'], car: 'Best in: Ertiga / Innova Crysta' },
];
