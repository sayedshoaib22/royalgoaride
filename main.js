    ...
    <div class="vc fade-in">
      <div class="vc-img-wrap">
        <img src="${v.img}" alt="${v.name} — Car Rental in Goa" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1494976388531-d1058494cdd8?auto=format&fit=crop&q=80&w=800'">
    ...
    <div class="route-card fade-in">
      <div class="route-img">
        <img src="${r.img}" alt="${r.title} — Goa Self Drive Route" loading="lazy">
